...
class PagineStandardTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        DB::table('pagine')->where('tipo', '=', 'standard')->delete();


        $pagineJsonFile = File::get(database_path('dataset/pagine_standard.json'));
