...
Route::group(['prefix' => 'foormaction'], function () {
...
Route::group(['prefix' => 'foormcaction'], function () {
    $whereFoorm = join("|", \Gecche\Cupparis\App\Facades\Cupparis::get('foorm.entities'));
...
Route::group(['prefix' => 'foorm'], function () {
    $whereFoorm = join("|", \Gecche\Cupparis\App\Facades\Cupparis::get('foorm.entities'));
    //die($whereFoorm);
    //die ($where);
...
Route::group(['prefix' => 'foormc', 'as' => 'foormc'], function () {
    $whereFoorm = join("|", \Gecche\Cupparis\App\Facades\Cupparis::get('foorm.entities'));
