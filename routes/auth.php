...
Route::get('/register-cie', [RegisteredUserController::class, 'createCie'])
    ->middleware('guest')
    ->name('register-cie');

Route::post('/register-cie', [RegisteredUserController::class, 'storeCie'])
    ->middleware('guest');

Route::get('/register-scuola', [RegisteredUserController::class, 'createScuola'])
    ->middleware('guest')
    ->name('register-scuola');

Route::post('/register-scuola', [RegisteredUserController::class, 'storeScuola'])
    ->middleware('guest');

Route::get('/login', [AuthenticatedSessionController::class, 'meta'])
    ->middleware('guest')
    ->name('meta-login');
...
Route::get('/login-classic', [AuthenticatedSessionController::class, 'create'])
    ->middleware('guest')
    ->name('login');
Route::get('/login-scuola', [AuthenticatedSessionController::class, 'createScuola'])
    ->middleware('guest')
    ->name('login-scuola');
