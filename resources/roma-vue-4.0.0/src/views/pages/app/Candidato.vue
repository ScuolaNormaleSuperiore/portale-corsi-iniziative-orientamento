...
function getStandardField(field, fieldType, fieldTypeParam, onlyRes, candValue) {
  ...
  var html = "<div class=\"col-4 font-bold text-right\">\n" +
        ...
        <div>
          ...
          <p class="text-left text-xl">
            ...
            <span v-if="candidato.data_candidatura" class="">
                    ...
                    <strong>
                      {{ getFormattedDateValue(candidato.data_candidatura) }}
                    </strong>
                </span>
          </p>
          <div v-if="candidato.attachments.length > 0" class="text-xl">
            Scarica gli allegati della domanda:
            <Download :url="'/api/foormaction/media-download/candidato/list/'+candidato.id" :method="'post'"/>
          </div>
        </div>
        <div>

          <p class="text-left text-xl">
            Preferenze sui corsi:<br/>
            <strong v-html="getStandardField('corsi','checkbox-relation',null,true)"></strong>
          </p>
                    ...
                    <DataTable :value="votiTotals"
                      ...
                      <Column v-for="(col) of votiColumns" :key="col.field" :field="col.field"
                        ...
                        <template #body="slotProps">
                          <div :class="col.field === 'materia_id' ? 'text-left' : 'text-right'"
                          >
