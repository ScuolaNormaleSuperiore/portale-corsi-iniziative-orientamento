                                ...
                                <div class="it-socials d-none d-md-flex">
                                    ...
                                    <ul>
                                        @foreach ($socials as $social)
                                            <li>
                                                <a href="{{$social['link']}}" aria-label="{{$social['nome']}}" target="_blank">
                                                    @if ($social['icona'])
                                                    <svg class="icon">
                                                        <use href="{{Theme::url('svg/sprites.svg')}}#{{$social['icona']}}"></use>
                                                    </svg>
                                                    @elseif ($social['svg'])
                                                        <svg class="icon" fill="{{$social['svg']['fill']}}" viewBox="{{$social['svg']['viewBox']}}">
                                                            <path fill="#005a73"
                                                                  d="{{$social['svg']['path']}}">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li>
                                                <a href="{{$social['link']}}" target="_blank">
                                                    ...
                                                    @elseif ($social['svg'])
                                                        <svg class="icon icon-sm icon-white align-top" fill="{{$social['svg']['fill']}}" viewBox="{{$social['svg']['viewBox']}}">
                                                            <path fill="#005a73"
                                                                  d="{{$social['svg']['path']}}">
                                                            </path>
                                                        </svg>
