...
@section('content-body')
    ...
    <div class="container-fluid">
        ...
        <section>
            <h2 class="pb-5">Registrazione scuola</h2>
            <hr/>
            ...
            >
                ...
                <div>
                    <p>Se l'indirizzo email della scuola che ti abbiamo indicato non è corretto o non è presidiato,
                        puoi indicare un nuovo indirizzo e-mail, ma dovremo prima approvare il cambio. Il messaggio per confermare il
...
{{--                </div>--}}
                ...
                <div class="d-none pt-4" id="cambiaEmailScuola">
                    <div class="form-group">
                        <input type="email" class="form-control" id="emailScuolaAggiornato" name="emailScuolaAggiornato">
                        <label for="emailScuolaAggiornato" class="" style="width: auto;">Indirizzo E-mail Scuola aggiornato</label>
                    ...
                    <div class="form-group pt-2">
                        ...
                        <textarea class="form-control border" id="noteEmailScuola" rows="3" name="noteEmailScuola"></textarea>
