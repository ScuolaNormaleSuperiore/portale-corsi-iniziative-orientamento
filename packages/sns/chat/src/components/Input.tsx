...
import { currentUserMessageAtom, fetchMessageAtom, isMessageLoadingAtom } from '@atoms/messages';
...
const Input: React.FC = () => {
  ...
  const handleSetCurrentMessage = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
